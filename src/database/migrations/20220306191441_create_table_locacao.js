...
// exports.up = knex => knex.schema.createTable('Locacao', table =>{
...
//     table.string('documento',25).references('documento').inTable('Usuario')
...
// exports.down = knex => knex.schema.dropTable('Locacao');